  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div 
          className="absolute left-0 w-full h-[155%] bg-cover will-change-transform"
          style={{ 
            top: '-35%',
      ...
      <div className="relative z-10 w-full max-w-5xl px-4 flex flex-col items-center text-center animate-fade-in-up pt-20 sm:pt-24 lg:pt-28 pb-8 sm:pb-12 mx-auto">
        ...
        <p className="text-[3.3vw] sm:text-lg lg:text-xl text-white mb-6 sm:mb-8 max-w-2xl font-medium drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] whitespace-nowrap sm:whitespace-normal px-2 sm:px-0 tracking-tight" dir="rtl">
